  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Decorative drum circles */}
        <svg
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] sm:w-[800px] sm:h-[800px] opacity-[0.06]"
          viewBox="0 0 800 800"
          fill="none"
        >
          <circle cx="400" cy="400" r="380" stroke="var(--primary)" strokeWidth="1" />
          <circle cx="400" cy="400" r="300" stroke="var(--primary)" strokeWidth="0.8" />
          <circle cx="400" cy="400" r="220" stroke="var(--primary)" strokeWidth="0.6" />
          <circle cx="400" cy="400" r="140" stroke="var(--primary)" strokeWidth="0.4" />
          <circle cx="400" cy="400" r="60" stroke="var(--primary)" strokeWidth="0.3" />
          {/* Cross lines (like drum skin) */}
          <line x1="400" y1="20" x2="400" y2="780" stroke="var(--primary)" strokeWidth="0.3" />
          <line x1="20" y1="400" x2="780" y2="400" stroke="var(--primary)" strokeWidth="0.3" />
          <line x1="120" y1="120" x2="680" y2="680" stroke="var(--primary)" strokeWidth="0.2" />
          <line x1="680" y1="120" x2="120" y2="680" stroke="var(--primary)" strokeWidth="0.2" />
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface border border-border mb-8 animate-fade-in">
          ...
          <span className="text-sm text-muted">Караимская 21 &bull; Есть парковка</span>
        </div>
        ...
        >
          Научим играть на{" "}
          <span className="text-gradient">барабанах</span>
          <br />с нуля
        </h1>
        ...
        >
          Для детей и взрослых. Индивидуальные занятия с профессиональным преподавателем.
        </p>
        ...
        >
          <CTAButton onClick={onBookingClick} pulse>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <span className="text-primary font-bold text-lg">1 300 &#8381;</span>
