...
export default function SectionCTA({ onBookingClick }: SectionCTAProps) {
  return (
    <section className="section">
      <AnimateOnScroll animation="scale-in">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-surface to-accent/5 border border-primary/20 p-8 sm:p-12 lg:p-16 text-center">
          {/* Background glow */}
